    ...
    <>
      <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
        <div className="text-center">
          <h2 className="text-3xl font-extrabold text-gray-900">N*N Grid boxes</h2>
          <div className="flex justify-center mt-4">
            <input type="number" className="w-10 h-10" placeholder="N" onChange={(e) => setRow(e.target.value)} value={row} />
            <span className="mx-2 text-bold">x</span>
            <input type="number" className="mx-2 w-10 h-10" placeholder="N" onChange={(e) => setColumn(e.target.value)} value={column} />
          </div>
        </div>
      </div>
